...
curl -fsS "http://127.0.0.1:${FLASK_PORT}/api/stream" >/dev/null 2>&1 || fail "Over-Seer SSE stream endpoint is not reachable"
pass "Over-Seer SSE stream endpoint is reachable"
